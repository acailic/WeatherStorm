package com.example.android.weatherstorm.app.service;
...
import com.example.android.weatherstorm.app.BuildConfig;
...
public class WeatherStormService extends IntentService {

    private final String LOG_TAG = WeatherStormService.class.getSimpleName();

    private ArrayAdapter<String> mForecastAdapter;
    public static final String LOCATION_QUERY_EXTRA = "lqe";

    public WeatherStormService() {
        super("WeatherStorm");
    }
